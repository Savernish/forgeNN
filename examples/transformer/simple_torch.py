...
# Resolve input.txt relative to this script's folder, with a fallback to CWD.
...
if _input_path is None:
	raise FileNotFoundError(
		"input.txt not found. Place it next to simple_torch.py or in the current working directory.\n"
